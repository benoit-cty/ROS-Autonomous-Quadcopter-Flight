...
struct MultiDofFollowJointTrajectoryFeedback_ {
  ...
  typedef  ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator>  _desired_type;
   ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator>  desired;

  typedef  ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator>  _actual_type;
   ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator>  actual;

  typedef  ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator>  _error_type;
   ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator>  error;
...
s << std::endl;
    ...
    s << indent << "desired: ";
s << std::endl;
    Printer< ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator> >::stream(s, indent + "  ", v.desired);
    s << indent << "actual: ";
s << std::endl;
    Printer< ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator> >::stream(s, indent + "  ", v.actual);
    s << indent << "error: ";
s << std::endl;
    Printer< ::moveit_msgs::MultiDOFJointTrajectoryPoint_<ContainerAllocator> >::stream(s, indent + "  ", v.error);
  }
};
